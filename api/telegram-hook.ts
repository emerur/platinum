...
Say goodbye to limits. Get instant access to RDPs & Residential Socks5 — no trials, no payments, just pure performance.
    ...
    await ctx.reply(reply, {
      ...
      reply_markup: {
        inline_keyboard: [
          [
            {
              text: "🚀 Join RDPs & Residential Socks5 Channel Now!",
              url: channelUrl,
            },
          ],
        ],
